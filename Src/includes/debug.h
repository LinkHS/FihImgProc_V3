...
#include <conio.h>
   ...
   // #define FIH_LOGE(fmt, args...)       printf(fmt, ## args) 
    ...
    #define FIH_PRINT                      _cprintf
//    #define FIH_LOGD(fmt, ...)             do { _cprintf("[%s] ", __FUNCTION__); _cprintf(fmt"\n", __VA_ARGS__); } while (0)
    #define FIH_LOGD(fmt, ...)             do { _cprintf(fmt"\n", __VA_ARGS__); } while (0)
//    #define FIH_LOGD(fmt, ...)             _cprintf("[%s] ", __FUNCTION__); _cprintf(fmt"\n", __VA_ARGS__); } while (0)
