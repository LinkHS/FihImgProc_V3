	...
	CCreateContext* pContext)
{
	...
	if (!m_wndSplitter.CreateView(0, 0, RUNTIME_CLASS(CLeftView), CSize(100, 100), pContext) ||
		!m_wndSplitter.CreateView(0, 1, RUNTIME_CLASS(CSHDRView), CSize(100, 100), pContext))
	{
...
CSHDRView* CMainFrame::GetRightPane()
{
	CWnd* pWnd = m_wndSplitter.GetPane(0, 1);
	CSHDRView* pView = DYNAMIC_DOWNCAST(CSHDRView, pWnd);
	return pView;
}
...
void CMainFrame::OnViewStyle(UINT nCommandID)
{
	...
	// if the right-hand pane has been created and is a CSHDRView,
